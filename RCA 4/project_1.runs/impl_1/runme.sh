...
HD_PWD='C:/Users/lolwa/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Ripple_Carry_Adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Ripple_Carry_Adder.tcl -notrace

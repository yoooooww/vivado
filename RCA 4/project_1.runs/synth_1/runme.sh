...
HD_PWD='C:/Users/lolwa/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Ripple_Carry_Adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Ripple_Carry_Adder.tcl

...
HD_PWD='C:/Users/lolwa/Low_part_or_Adder 16/Low_part_or_Adder 16.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Low_part_OR_Adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Low_part_OR_Adder.tcl -notrace

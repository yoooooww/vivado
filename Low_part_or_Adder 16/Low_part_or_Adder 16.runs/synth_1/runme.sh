...
HD_PWD='C:/Users/lolwa/Low_part_or_Adder 16/Low_part_or_Adder 16.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Low_part_OR_Adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Low_part_OR_Adder.tcl

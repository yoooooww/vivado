...
HD_PWD='C:/Users/lolwa/Carry_Adder 16/Carry_Adder 16.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Carry_Adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Carry_Adder.tcl -notrace

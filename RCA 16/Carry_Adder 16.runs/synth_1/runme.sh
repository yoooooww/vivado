...
HD_PWD='C:/Users/lolwa/Carry_Adder 16/Carry_Adder 16.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Carry_Adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Carry_Adder.tcl

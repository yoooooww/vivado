...
HD_PWD='C:/Users/lolwa/Error_Tolerant_Adder 16 2/Error_Tolerant_Adder 8 2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Error_Tolerant_Adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Error_Tolerant_Adder.tcl

...
HD_PWD='C:/Users/lolwa/Error_Tolerant_Adder 16 2/Error_Tolerant_Adder 8 2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Error_Tolerant_Adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Error_Tolerant_Adder.tcl -notrace
